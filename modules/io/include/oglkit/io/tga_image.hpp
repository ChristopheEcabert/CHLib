...
#ifndef __OGLKIT_TGA_IMAGE__
#define __OGLKIT_TGA_IMAGE__
 ...
 *  @ingroup io
 */
class OGLKIT_EXPORTS TGAImage : public Image {
 public:
 ...
 *  @ingroup io
 */
class OGLKIT_EXPORTS TGAProxy : public ImageProxy {
 public:
