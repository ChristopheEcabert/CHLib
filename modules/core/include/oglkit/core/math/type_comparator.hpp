...
#ifndef __OGLKIT_TYPE_COMPARATOR__
#define __OGLKIT_TYPE_COMPARATOR__
 ...
 */
template<typename T>
class OGLKIT_EXPORTS TComparator {
 ...
 */
template<>
class OGLKIT_EXPORTS TComparator<float> {
 ...
 */
template<>
class OGLKIT_EXPORTS TComparator<double> {
...
#endif /* __OGLKIT_TYPE_COMPARATOR__ */
