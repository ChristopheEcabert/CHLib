...
#ifndef __CHLIB_TYPE_COMPARATOR__
#define __CHLIB_TYPE_COMPARATOR__
 ...
 */
template<typename T>
class CHLIB_EXPORTS TComparator {
 ...
 */
template<>
class CHLIB_EXPORTS TComparator<float> {
 ...
 */
template<>
class CHLIB_EXPORTS TComparator<double> {
...
#endif /* __CHLIB_TYPE_COMPARATOR__ */
